...
export const inputSigleFileVariants = tv({
  base: `
...
interface InputSingleFileProps
  extends VariantProps<typeof inputSigleFileVariants>,
...
export default function InputSingleFile({
  ...
  function isValidSize() {
    const masFileSizeInBytes = maxFileSizeInMB * 1024 * 1024;
    return fileSize <= masFileSizeInBytes;
  }
        ...
        <>
          <div className="w-full relative group cursor-pointer">
            <input
              ...
              {...props}
            />
            <div className={inputSigleFileVariants({ size })}>
              <Icon
                svg={UpdateFileIcon}
          ...
          <div className="flex flex-col gap-1 mt-1">
            ...
            {formFile && !isValidSize() && (
              <Text variant="label-small" className="text-accent-red">
                O tamanho do arquivo ultrapassa o limite máximo
              </Text>
            )}
            {formFile && error && (
              <Text variant="label-small" className="text-accent-red">
